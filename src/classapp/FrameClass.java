...
public class FrameClass {
	...
	public FrameClass() {
		...
		fc.setBounds(500, 200, 800	, 600);
		fc.setLayout(null);

		// Frame 안의 각 객체들 자리잡기
		
		Button login = new Button("조회");
		login.setBounds(240, 45, 50, 40);
		login.setEnabled(true);

		Label info = new Label();
		info.setBounds(400, 90, 100, 60);

		Label search = new Label("강의시간표 검색");
		search.setBounds(50, 180, 100, 30);

		Button ask = new Button("신청");
		ask.setBounds(715, 225, 50, 150);
		ask.setEnabled(false);

		Button cancel = new Button("신청\n취소");
		cancel.setBounds(715, 480, 50, 150);
		cancel.setEnabled(false);
		cancel.setVisible(false);
		
		Button save = new Button("저장");
		save.setBounds(720, 45, 50, 40);
//		
...
//		
		...
		credit_now.setBounds(620, 180, 170, 30);
		

		// 학부 선택했을 때, 학부에 해당하는 과 choice목록 띄우기
		Choice major = new Choice();
		major.setBounds(310, 180, 120, 50);
		...
		login.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				info.setText(LoginFrame.id_str);
